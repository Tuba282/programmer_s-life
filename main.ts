...
async function motivation() {
  ...
  if (Person.man === "Sad") {
    ...
    console.log(
      ...
      \n\t he does'nt say I failed 99 times,he said I invented 99  new methods of how  bulb can't shine.
      \n\tAperson who never made a mistake never tried to do something new.
      `
    );
    ...
    console.log(
      `\t\nWhen you feel like quitting think about why you should start.
       ...
       \n\tand start your life function again.`
    );
  } else {
    console.log(
